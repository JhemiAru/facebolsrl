...
<div class="empresa-container">
    <div class="empresa-card text-center">
        <h3 class="empresa-nombre">Listado de lugar del #{{ $lugar->id }}</h3>
        <div class="empresa-info text-start mt-4">
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Estado:</strong>&nbsp;
            @if ($lugar->estado == 0)
            ...
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Ciudad:</strong>&nbsp; {{ $lugar->ciudad }}</div>
            <div class="info-item"><i class="bi bi-geo-alt-fill"></i> <strong>Departamento:</strong>&nbsp; {{ $lugar->departamento }}</div>
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Provincia:</strong>&nbsp; {{ $lugar->provincia }}</div>
        </div>

        <a href="{{ route('lugar.index') }}" class="btn-volver">
