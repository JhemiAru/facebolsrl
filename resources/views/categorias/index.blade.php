...
<style>
    ...
    <div class="content">
        <h1 class="text-center"><b>Bienvenido a la Administración de Categorias</b></h1>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('/categorias/create') }}" class="btn btn-primary">
                                <i class="bi bi-file-plus"></i> Agregar Nueva Categorias
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <?php $contador = 0; ?>
                                 @foreach ($categoria as $categorias)
                                    <tr>
                                        ...
                                        <td>{{ strtoupper($categorias->nombre) }}</td>
                                        <td>{{ strtoupper($categorias->descripcion) }}</td>
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ url('categorias', $categorias->id) }}" type="button" class="btn btn-info" title="Ver">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('categorias.edit', $categorias->id) }}" type="button" class="btn btn-success" title="Editar">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <form action="{{ url('categorias', $categorias->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
