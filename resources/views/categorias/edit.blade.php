...
<div class="card mt-5 shadow-lg border-0">
    <div class="card-header bg-dark text-white">
        <h4 class="mb-0"><i class="bi bi-pencil-square"></i> Editar Categoria</h4>
    </div>
    <div class="card-body bg-light">
        ...
        <form action="{{ route('categorias.update', $categoria->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold text-dark">Nombre Categorias</label>
                    <input type="text" name="nombre" class="form-control rounded-pill" style="text-transform: uppercase; color: #000000 !important; background: rgba(255, 255, 255, 0.95) !important;"
                           value="{{ old('nombre', $categoria->nombre) }}">
                    @error("nombre") <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold text-dark">Descripcion</label>
                    <input type="text" name="descripcion" class="form-control rounded-pill" style="text-transform: uppercase; color: #000000 !important; background: rgba(255, 255, 255, 0.95) !important;"
