...
@section('content')
    <style>
        ...
        *::after {
        ...
        /* ============================================================ */
        /* ===== ESTILOS DEL CALENDARIO (RESPONSIVE Y CON ANIMACIONES) ===== */
        /* ============================================================ */
        .calendario-container {
            ...
            padding: 15px;
            margin-bottom: 20px;
            border: none; /* Eliminamos el borde que se veía feo */
            overflow: hidden;
        ...
        .calendario-header button:active {
        ...
        .calendario-dia-presente:hover {
            background: rgba(16, 185, 129, 0.35);
            box-shadow: 0 0 20px rgba(16, 185, 129, 0.2);
        }
        .calendario-dia-presente .calendario-dia-numero { color: #10b981; }
        ...
        .calendario-dia-falta:hover {
            background: rgba(239, 68, 68, 0.35);
            box-shadow: 0 0 20px rgba(239, 68, 68, 0.2);
        }
        .calendario-dia-falta .calendario-dia-numero { color: #ef4444; }
        ...
        .calendario-dia-permiso:hover {
            background: rgba(245, 158, 11, 0.35);
            box-shadow: 0 0 20px rgba(245, 158, 11, 0.2);
        }
        .calendario-dia-permiso .calendario-dia-numero { color: #f59e0b; }
        ...
        .calendario-dia-retraso:hover {
            background: rgba(59, 130, 246, 0.35);
            box-shadow: 0 0 20px rgba(59, 130, 246, 0.2);
        }
        .calendario-dia-retraso .calendario-dia-numero { color: #3b82f6; }

        /* ===== INDICADOR DE ESTADO (AJUSTADO AL CONTENIDO) ===== */
        .calendario-indicador {
            color: #f1f5f9 !important;
            font-size: 0.6rem;
            margin-top: 2px;
            padding: 1px 6px; /* padding horizontal reducido */
            border-radius: 3px;
        ...
        .calendario-dia:hover .calendario-indicador {
            background: rgba(0, 0, 0, 0.8);
            transform: scale(1.05);
        }

        /* ===== LEYENDA MEJORADA (texto blanco, sin bordes, tamaño original) ===== */
        .calendario-leyenda {
            display: flex;
            gap: 20px;
            margin-top: 20px;
            padding: 10px 0; /* sin padding lateral, solo arriba/abajo */
            justify-content: center;
            flex-wrap: wrap;
        ...
        .leyenda-item {
            ...
            align-items: center;
            gap: 8px;
            font-size: 0.85rem; /* tamaño original */
            color: #ffffff; /* texto blanco */
            transition: transform 0.3s ease;
        }
        .leyenda-item:hover {
            transform: scale(1.05);
            /* Sin cambio de color, se mantiene blanco */
        }
        .leyenda-color {
            width: 16px;
            height: 16px;
        ...
        .leyenda-item:hover .leyenda-color {
            transform: scale(1.2);
        ...
        @media (max-width: 768px) {
            .calendario-container { padding: 10px; }
            .calendario-header {
                flex-direction: row;
                flex-wrap: wrap;
                justify-content: center;
            ...
            .calendario-dias-semana { gap: 2px; }
            /* Leyenda responsiva */
            .calendario-leyenda {
                gap: 12px;
                font-size: 0.7rem;
        ...
        @media (max-width: 480px) {
            .calendario-dia-numero { font-size: 0.65rem; }
            .calendario-indicador {
                font-size: 0.4rem;
                padding: 0 3px;
                margin-top: 0;
            ...
            .calendario-mes-titulo { font-size: 0.95rem; }
            .calendario-container { padding: 6px; }
            .calendario-dia { padding: 1px; }
            .calendario-leyenda { gap: 8px; }
            .leyenda-item { font-size: 0.6rem; }
            .leyenda-color { width: 10px; height: 10px; }
        }

        /* ===== ESTILOS MEJORADOS PARA EL MODAL DETALLE ===== */
        .modal-detalle-asistencia .modal-body {
            background: #0f2027;
            color: #f1f5f9;
            padding: 25px;
        }

        .modal-detalle-asistencia .card-detalle {
        ...
        .modal-detalle-asistencia .card-detalle h6 {
            color: #58a6ff;
            font-weight: 700;
            margin-bottom: 12px;
        ...
        .modal-detalle-asistencia .card-detalle ul {
            list-style: none;
            padding-left: 0;
            margin-bottom: 0;
        }

        .modal-detalle-asistencia .card-detalle ul li {
            padding: 6px 0;
        ...
        .modal-detalle-asistencia .card-detalle ul li .valor {
            font-weight: 700;
            color: #f1f5f9;
        }

        .modal-detalle-asistencia .card-detalle ul li .text-success {
            color: #34d399 !important;
        }

        .modal-detalle-asistencia .card-detalle ul li .text-danger {
            color: #f87171 !important;
        }

        .modal-detalle-asistencia .total-destacado {
        ...
        .modal-detalle-asistencia .total-destacado span {
            color: #34d399;
            font-size: 1.1rem;
        }

        .modal-detalle-asistencia .total-destacado.danger {
            border-color: #ef4444;
            background: rgba(239, 68, 68, 0.12);
        }

        .modal-detalle-asistencia .total-destacado.danger span {
            color: #f87171;
        }

        .modal-detalle-asistencia .total-destacado.warning {
            border-color: #f59e0b;
            background: rgba(245, 158, 11, 0.12);
        }

        .modal-detalle-asistencia .total-destacado.warning span {
            color: #fbbf24;
        }

        .modal-detalle-asistencia .badge-contador {
            background: #1a365d;
            color: #58a6ff;
            padding: 6px 14px;
            border-radius: 20px;
        ...
        .modal-detalle-asistencia .badge-contador .numero {
            color: #f1f5f9;
            font-size: 1.1rem;
            margin-left: 4px;
        }

        .modal-detalle-asistencia .seccion-titulo {
            color: #58a6ff;
            font-weight: 700;
            font-size: 1.1rem;
        ...
        .modal-detalle-asistencia .seccion-titulo i {
            font-size: 1.3rem;
        }

        .modal-detalle-asistencia .grid-2col {
            display: grid;
        ...
        .modal-detalle-asistencia .texto-claro {
            color: #e2e8f0;
        }

        .modal-detalle-asistencia .texto-azul {
            color: #58a6ff;
        }

        .modal-detalle-asistencia .texto-verde {
            color: #34d399;
        }

        .modal-detalle-asistencia .texto-rojo {
            color: #f87171;
        }

        .modal-detalle-asistencia .texto-amarillo {
            color: #fbbf24;
        }

        /* Mejora de contraste para inputs dentro del modal */
        .modal-detalle-asistencia .form-control,
        .modal-detalle-asistencia .form-select {
            background: rgba(255, 255, 255, 0.08) !important;
            border: 1px solid rgba(255, 255, 255, 0.15) !important;
            color: #f1f5f9 !important;
        }

        .modal-detalle-asistencia .form-control:focus,
        .modal-detalle-asistencia .form-select:focus {
            border-color: #58a6ff !important;
            box-shadow: 0 0 0 0.2rem rgba(88, 166, 255, 0.25);
        }

        .modal-detalle-asistencia .form-control::placeholder {
    ...
    <div style="display: none;">
        ...
        <!-- ===== CALENDARIO DE ASISTENCIAS (PANEL INDEPENDIENTE, FUERA DEL MODAL) ===== -->
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3><i class="bi bi-calendar3"></i> Calendario de Asistencias</h3>
                    </div>
                    <div class="card-body">
        ...
        <!-- ============================================================ -->
        <!-- ===== MODAL DETALLE DE ASISTENCIAS - VERSIÓN MEJORADA ===== -->
        <!-- ============================================================ -->
        <div class="modal fade modal-detalle-asistencia" id="detalleAsistenciasModal" tabindex="-1"
            aria-labelledby="detalleAsistenciasLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center mb-4">
                            <span class="badge-contador">
                                <i class="bi bi-clipboard-data me-1"></i> Total de asistencias registradas:
                                <span class="numero">{{ $asistencias->count() }}</span>
                            </span>
                        </div>

                        <!-- ===== 2. RESUMEN EN TARJETAS (2 columnas) ===== -->
                        <div class="grid-2col">

                            <!-- Actividades de la Empresa -->
                            <div class="card-detalle">
                                <h6><i class="bi bi-briefcase-fill me-2"></i>Actividades de la Empresa</h6>
                                <ul>
                                    @php
                                    ...
                                    @foreach ($actividadesPermitidas as $id => $nombre)
                                        ...
                                        <li>
                                            <span>{{ $nombre }}</span>
                                            <span class="valor">{{ $items->count() }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <!-- Tipo de Asistencia -->
                            <div class="card-detalle">
                                <h6><i class="bi bi-tag-fill me-2"></i>Tipo de Asistencia</h6>
                                <ul>
                                    @php
                                        $asistenciasTipo = [
                        ...
                        <!-- ===== 3. ATRASOS (2 columnas) ===== -->
                        <div class="seccion-titulo">
                            <i class="bi bi-clock-history"></i> Atrasos
                        </div>
                        <div class="grid-2col">

                            <!-- Atrasos registrados (totales) -->
                            <div class="card-detalle">
                                <h6><i class="bi bi-list-ul me-2"></i>Resumen de Atrasos</h6>
                                @php
                                    $costos = [
                                        'ATRASO1' => 1,
                                        'ATRASO2' => 2,
                                ...
                                <ul>
                                    @foreach ($tiposAtraso as $tipo => $datos)
                                        <li>
                                            ...
                                            <span class="valor">
                                                {{ $datos['cantidad'] }}
                                                <span class="texto-claro" style="font-weight:400; font-size:0.8rem;">
                                                    ({{ $datos['costo'] }} Bs c/u → {{ $datos['total'] }} Bs)
                                                </span>
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
                                <div class="total-destacado warning">
                                    <i class="bi bi-calculator me-2"></i> Total Atrasos: <span>{{ $totalAtrasos }} Bs</span>
                                </div>
                            </div>

                            <!-- Atrasos Cancelados / Deudas -->
                            <div class="card-detalle">
                                <h6><i class="bi bi-credit-card-2-front me-2"></i>Cancelados vs Deudas</h6>
                                @php
                                    $costos2 = [
                                        'ATRASO1' => 1,
                                        'ATRASO2' => 2,
                                ...
                                <ul>
                                    @foreach ($costos2 as $tipo => $costo)
                                        ...
                                        <li>
                                            <span>{{ $tipo }}</span>
                                            <span class="valor">
                                                <span class="text-success">✔ {{ $cancelados }} ({{ $totalCancelados }}
                                                    Bs)</span>
                                                <span class="text-danger">✘ {{ $deudas }} ({{ $totalDeudas }}
                                                    Bs)</span>
                                            </span>
                                        </li>
                                    @endforeach
                                ...
                                <div class="total-destacado">
                                    <i class="bi bi-check-circle me-2"></i> Total Cancelados:
                                    <span>{{ $totales['cancelados'] }} Bs</span>
                                </div>
                                <div class="total-destacado danger">
                                    <i class="bi bi-exclamation-triangle me-2"></i> Total Deudas:
                                    <span>{{ $totales['deudas'] }} Bs</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- ===== 4. FALTAS ===== -->
                        <div class="seccion-titulo">
                            <i class="bi bi-x-circle"></i> Faltas
                        </div>
                        <div class="grid-2col">
                            <div class="card-detalle">
                                <h6><i class="bi bi-bar-chart me-2"></i>Resumen de Faltas</h6>
                                @php
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <span class="valor">{{ $cantidadFaltas }}</span>
                                    </li>
                                    <li>
                                        <span class="text-success">✔ Canceladas</span>
                                        <span class="valor text-success">{{ $cantidadCanceladas }}</span>
                                    </li>
                                    <li>
                                        <span class="text-danger">✘ Pendientes</span>
                                        <span class="valor text-danger">{{ $cantidadDeudas }}</span>
                                    </li>
                                </ul>
                                <div class="total-destacado">
                                    <i class="bi bi-calculator me-2"></i> Total Faltas: <span>{{ $totalFaltas }} Bs</span>
                                </div>
                                <div class="total-destacado">
                                    <i class="bi bi-check-circle me-2"></i> Canceladas: <span>{{ $totalCanceladas }}
                                        Bs</span>
                                </div>
                                <div class="total-destacado danger">
                                    <i class="bi bi-exclamation-triangle me-2"></i> Pendientes: <span>{{ $totalDeudas }}
                                        Bs</span>
                                </div>
                            </div>

                            <!-- ===== 5. CONTROL DE ASISTENCIAS EXTRAS ===== -->
                            <div class="card-detalle">
                                <h6><i class="bi bi-plus-circle me-2"></i>Asistencias Extras Ganadas</h6>
                                ...
                                @else
                                    <div class="text-center mb-3">
                                        <input type="number" id="inputAsistencias" class="form-control text-center"
                                            style="width: 90px; display: inline-block; margin:0 auto;" min="0"
                                ...
                                <div class="text-center">
                                    <b>Extra (Laborales):</b>
                                    <span id="extraLaboralesTexto" class="texto-azul">00:00:00</span>
                                    &nbsp;|&nbsp;
                                    <b>Extra (Académicas):</b>
                                    <span id="extraAcademicasTexto" class="texto-verde">00:00:00</span>
                                </div>
                        ...
                        <div class="grid-2col">
                            ...
                            <div class="card-detalle">
                                ...
                                <p class="texto-claro" id="horas_descuento_total">
                                    <i class="bi bi-clock me-1"></i> Descuento de horas totales:
                                    <strong class="texto-azul">{{ $totalHora->horas_descuento ?? 0 }}</strong>
                                </p>
                                ...
                                @can('asistencia')
                                    <div class="mb-2">
                                        ...
                                        <span id="motivoError" class="text-danger small"></span>
                                    </div>
                                @endcan
                                ...
                                <div class="text-center">
                                    @can('asistencia')
                                        <button class="btn btn-primary btn-sm" onclick="guardarDescuentoHoras()">
                                            <i class="bi bi-save me-1"></i>Guardar Descuento
                                        </button>
                                    @endcan
                                    <button type="button" class="btn btn-secondary btn-sm" id="btnTipoDescuento">
       ...
       <!-- ===== MODAL DESCUENTO (detalle de motivos) ===== -->
<div class="modal fade" id="tipoDescuento" tabindex="-1" aria-labelledby="tipoDescuentoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-light">Detalles de descuento</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                @php
                    ...
                    $totales = [];
                    // 💡 LEER DIRECTAMENTE DEL OBJETO ÚNICO DE LA BASE DE DATOS
                    // Si $totalHora no existe, usamos un objeto vacío por seguridad.
                    $registro = $totalHora ?? new \App\Models\TotalHora();

                    foreach ($motivos as $campo => $label) {
                        // Extraemos el valor de la columna; si es null, se convierte en 0
                        $totales[$campo] = (int)($registro->$campo ?? 0);
                    }
                @endphp

                <p class="lead text-light"><b>Totales de descuentos por motivo (horas)</b></p>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped text-center" id="tablaDescuentos">
                        ...
                        <tbody>
                            @foreach ($motivos as $campo => $label)
                                @php 
                                    // Genera ids en minúsculas limpios: 'atrasos', 'informe', 'descuento'
                                    $idCelda = strtolower(explode(' ', $label)[0]); 
                                @endphp
                                <tr @class(['bg-secondary' => $idCelda === 'descuento'])>
                                    <td class="text-start fw-semibold text-light">{{ $label }}</td>
                                    <!-- Asignamos el ID dinámico a la celda para que tu JS también pueda encontrarla y actualizarla -->
                                    <td class="fw-bold text-light" id="{{ $idCelda }}">
                                        {{ $totales[$campo] }}
                                    </td>
                                </tr>
                            @endforeach
        ...
        <!-- ===== CONTENEDOR DE ALERTAS TOAST (Añadir esto antes de los <script>) ===== -->
<div class="toast-container position-fixed bottom-0 end-0 p-3" style="z-index: 1100;">
    <div id="toastGuardado" class="toast align-items-center text-white bg-dark border-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="d-flex">
            <div class="toast-body" id="toastMensaje">
                <!-- El mensaje se inyectará dinámicamente aquí -->
            </div>
        ...
        <script>
    // Pasamos el registro único directamente (si viene como colección en tu controlador, usa $totalHora)
    const registrosDescuentos = @json($totalHora); 
    ...
    document.getElementById('selectMotivo').addEventListener('change', function() {
        ...
        if (selectValue !== 'Seleccione motivo' && selectValue !== '') {
            ...
            // 💡 LEER DESDE LA ESTRUCTURA REAL DE TU TABLA SQL
            if (campoBD && registrosDescuentos && registrosDescuentos[campoBD] !== undefined) {
                // Si el valor en la BD es null, ponemos 0
                const valor = registrosDescuentos[campoBD] !== null ? registrosDescuentos[campoBD] : 0;
                document.getElementById('inputDescuentoHoras').value = parseInt(valor, 10);
            } else {
        ...
        <script>
            ...
            const URL_GUARDAR_EXTRA = "{{ route('ajuste-horas.guardar-extra', $inscripcions->id) }}";
            const URL_GUARDAR_DESCUENTO = "{{ route('ajuste-horas.guardar-descuento', $inscripcions->id) }}";
    ...
    const toastMensajeEl = document.getElementById('toastMensaje');
    
    if (!toastEl || !toastMensajeEl) {
        // Alternativa si el elemento HTML no existe: usar un alert básico o console.log
        alert(mensaje);
        return;
    }

    toastMensajeEl.innerText = mensaje;
...
async function guardarHorasLocal() {
    ...
    try {
        // 1. Usamos la constante global URL_GUARDAR_EXTRA que ya tenías definida
        // 2. Extraemos el token directamente del meta tag o de la página
        // 3. Estructuramos el bodyData con la clave 'asistencias' que espera el AsistenciaJsonController
        ...
        if (data.success || data.ok) {
            ...
            // Actualizar los valores en la vista principal si el servidor los retorna
                ...
                obtenerEstadoAsistencia(fecha) {
                    ...
                    switch (asistencia.asistencia) {
                        ...
                        case 'P':
                            return {
                                estado: 'permiso',
                                clase: 'calendario-dia-permiso',
                                texto: 'Permiso',
                                motivo: asistencia.multa?.nombre_multa || 'Permiso'
                            };
                        default:
