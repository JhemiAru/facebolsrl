...
@section('title', 'Detalles de la Lugar')
...
<div class="empresa-container">
    <div class="empresa-card text-center">
        <h3 class="empresa-nombre">Listado de Sucursal del #{{ $sucursal->id }}</h3>
        <div class="empresa-info text-start mt-4">
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Direccion:</strong>&nbsp; {{ $sucursal->direccion }}</div>
            <div class="info-item"><i class="bi bi-geo-alt-fill"></i> <strong>Telefono:</strong>&nbsp; {{ $sucursal->telefono }}</div>
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Cuidad:</strong>&nbsp; {{ $sucursal->lugar->departamento }}</div>
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Empresa:</strong>&nbsp; {{ $sucursal->empresa->nombre_empresa }}</div>
            <div class="info-item"><i class="bi bi-person-fill"></i> <strong>Tipo de Sede:</strong>&nbsp; {{ $sucursal->tipoSede->nombreSede }}</div>
        </div>

        <a href="{{ route('sucursal.index') }}" class="btn-volver">
