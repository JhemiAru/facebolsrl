...
<style>
        ...
        <div class="card shadow-lg border-0 rounded-4 animate__animated animate__fadeIn">
            ...
            <div class="card-header rounded-top-4 p-4"
                ...
                <h5 class="mb-0 text-white fw-bold d-flex align-items-center">
                    <i class="fas fa-building me-2"></i> Adicionar Sucursal
                </h5>
            </div>

            <!-- Cuerpo del formulario -->
            <div class="card-body bg-white p-5 rounded-bottom-4">
                <form action="{{ route('sucursal.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate id="empresaForm">
                    @csrf
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="direccion" class="form-control rounded-pill shadow-sm"
               value="{{ old('direccion') }}" style="text-transform: uppercase;" required>
    ...
    <div class="col-md-4">
        ...
        <select name="id_lugar" class="form-select rounded-pill shadow-sm" required>
    ...
    <div class="col-md-4">
        ...
        <select name="id_empresa" class="form-select rounded-pill shadow-sm" required>
    ...
    <div class="col-md-4">
        ...
        <select name="id_tiposede" class="form-select rounded-pill shadow-sm" required>
