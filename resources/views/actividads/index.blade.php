...
@section('content')
    <div class="content" style="margin-left: 10px">
        <h1 class="text-center"><b>Bienvenido a la Administración de las Actividades</b></h1>
                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="{{ url('/actividads/create') }}" class="btn btn-primary">
                                <i class="bi bi-file-plus"></i> Agregar Nuevo Actividad
                            </a>
                        </div>
                    </div>
                    <div class="card-body " style="...">
                        ...
                        <table id="example1" class="table table-bordered table-striped table-m text-center">
                            <thead>
                                <tr>
                                    <th>Nro</th>
                                    <th>Nombres de las Actividades</th>
                                    <th>Accion</th>
                                </tr>
                            </thead>
                            <tbody>
