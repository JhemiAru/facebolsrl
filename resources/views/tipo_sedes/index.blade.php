...
<style>
    ...
    <div class="content">
        <h1 class="text-center"><b>Bienvenido a la Administración de las Tipo de Sedes</b></h1>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><b>Tipo de Sedes Registradas</b></h3>
                        <div class="card-tools">
                            <a href="{{ url('/tipo_sedes/create') }}" class="btn btn-primary">
                                <i class="bi bi-file-plus"></i> Agregar nueva tipo de sedes
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped table-m">
                            ...
                            <tbody>
                                <?php $contador = 0; ?>
                                 @foreach ($tipo_sed as $tipo_sede)
                                    <tr>
                                        <td><?php echo $contador = $contador + 1; ?></td>
                                        <td>{{ strtoupper($tipo_sede->nombreSede) }}</td>
                                        <td style="text-align: center">
                                            @if (strtoupper($tipo_sede->estado == 0))
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ url('tipo_sedes', $tipo_sede->id) }}" type="button" class="btn btn-info" title="Ver">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('tipo_sedes.edit', $tipo_sede->id) }}" type="button" class="btn btn-success" title="Editar">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <form action="{{ url('tipo_sedes', $tipo_sede->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                            ...
                            $(function() {
                                $("#example1").DataTable({
                                    ...
                                    "language": {
                                        ...
                                        "info": "Mostrando _START_ a _END_ de _TOTAL_ Tipo de Sede",
                                        "infoEmpty": "Mostrando 0 a 0 de 0 Tipo de Sede",
                                        "infoFiltered": "(Filtrado de _MAX_ total Tipo de Sede)",
                                        "infoPostFix": "",
                                        "thousands": ",",
                                        "lengthMenu": "Mostrar _MENU_ Tipo de Sede",
